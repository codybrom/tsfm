...
const sections: Section[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        url: "/guide/system-one",
        summary: "Local Jev-shaped choice, score, and noul decisions",
      },
    ],
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        url: "/api/system-one",
        summary: "SystemOneClient and typed decision primitives",
      },
    ],
  },
  {
...
export function generateLlmTxt(): string {
  const lines: string[] = [
    "# tsfm",
    "",
    "> TypeScript SDK for Apple Foundation Models framework — on-device Apple Intelligence inference in Node.js via Node-API. macOS 26+, Apple Silicon only.",
    "",
  ];
